...
function Navbar() {
  ...
  // use local storage so that admin dashboard becomes visible to only admin when he login vice-versa for the user about the order page
                  ...
                  <Link to={'/allproducts'} className="text-sm font-medium text-gray-900 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                   ...
                   {user && (
                    <div className="flow-root">
                      <Link to={'/order'} className="-m-2 block p-2 font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>
                        Order
                      </Link>
                    </div>
                  )}
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>URBAN CART</h1>
                  </div>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  {!user && (
                    <a onClick={() => (window.location.href = '/login')} className="text-sm font-medium text-gray-700 cursor-pointer"
